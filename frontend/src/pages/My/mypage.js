    ...
    const Mypage = () => {
        ...
        const handleGoProflieSetting = () => {

        };
        const handleGoGloplerSetting = () => {
            navigate('/agentperspective');
        };
        const handleGoPointSetting = () => {
        };
                    ...
                    <SettingContainer>
                        <ProfileSettingBtn>
                            <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_767_1672)">
                                    <path
